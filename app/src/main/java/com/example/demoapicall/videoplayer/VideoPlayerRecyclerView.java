package com.example.demoapicall.videoplayer;
...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(!isEndOfList){
            ...
            targetPosition = MediaModels.size() - 1;
        }
        ...
        ItemRowHomeList.ItemRowViewHolder holder = (ItemRowHomeList.ItemRowViewHolder) child.getTag();
        if (holder == null) {
            playPosition = -1;
            return;
        }
        progressBar = holder.getProgress();
        viewHolderParent = holder.itemView;
        frameLayout = holder.getMediaUrl();
        ...
        String mediaUrl = MediaModels.get(targetPosition).getMediaurl();
        if (mediaUrl != null) {
